...
Plans:
- [x] 12.7-01-PLAN.md - Data coverage preflight and row-loss telemetry
- [x] 12.7-02-PLAN.md - Causal label builder and leakage-safe splits
- [x] 12.7-03-PLAN.md - Walk-forward promotion gate and calibration report
...
- [x] 14-03-PLAN.md - Elliott Wave governance integration, ML features, and audit logging
